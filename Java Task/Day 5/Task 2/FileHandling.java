...
case 2:
	...
	System.out.println("Enter the sentance to write in file "+file.getName()+" : ");
	String sentance = scan.nextLine();
	FileWriter writer = new FileWriter(file);
	System.out.println("The data is written in the file "+file.getName()+ " stored in the path "+file.getAbsolutePath());
